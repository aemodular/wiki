...
The original edition, in white and silver, was limited to an edition of 50 (25 via Hot Air, 25 via wonkystuff). Subsequently, there was also a black/gold version, also limited to an edition of 50.

(The panel is double-sided, in case you would like a change of view.)

## Controls

* 8 touch plates, with mystical symbols attached.
...
Each touch plate has a pair of sockets associated with it, there are no specified *in* or *out* connections, they can be what you want them to be…

# Additional

John from wonkystuff made a video about the building of the kit:
